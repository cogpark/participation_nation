...
People with Libertarian leanings often vote for Republicans and [conservatives](/whats-a-conservative), since those groups are less likely than Democrats to propose government solutions to social problems. For example, Republicans and Libertarians agree that we should pay less in taxes, there should be fewer regulations on business, and that individuals and private companies should be able to do whatever they want with land and resources they own.  

However, Libertarians also share beliefs with [Democrats](/whats-a-democrat) and [liberals](/whats-a-liberal), such as that government shouldn’t police personal choices that don’t affect other people, such as if 2 men can get married, whether marijuana should be legal.
...
`
export default function WhatsALibertarian() {
